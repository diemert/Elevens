...
public class ElevensBoard extends Board{
	...
	public boolean isLegal(List<Integer> selectedCards) {
		if ((selectedCards.size() == 2 && this.containsPairSum11(selectedCards)) ||
				(selectedCards.size() == 3 && this.containsJQK(selectedCards))) return true;
		else return false;
	}
	...
	public boolean anotherPlayIsPossible() {
		...
		if (this.containsPairSum11(selectedCards) ||
				this.containsJQK(selectedCards)) return true;
		else return false;
	}
	...
	private boolean containsJQK(List<Integer> selectedCards) {
		...
		for (int x = 0; x < selectedCards.size(); x++) {
			Card aCard = cardAt(x);
			if (aCard.rank() == "jack") foundJ = true;
			if (aCard.rank() == "queen") foundQ = true;
			if (aCard.rank() == "king") foundK = true;
		}
